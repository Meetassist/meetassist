...
import { UpdateEvent } from "@/lib/actions/createEvent";
...
import { ArrowRight, Ellipsis, Pen, X } from "lucide-react";
      ...
      >
        ...
        {participants === 1 || participants === 2 ? (
          ...
          >
            ...
            <form
              onSubmit={handleSubmit(handleUpdateMeeting)}
              className="contents"
            >
              <DialogHeader className="-mt-8 flex flex-row items-center justify-between gap-4 text-xl font-semibold sm:gap-8 sm:text-2xl">
                ...
                <DialogTitle className="sr-only">Update Meeting</DialogTitle>
                <DialogClose asChild>
                  <button
                    type="button"
